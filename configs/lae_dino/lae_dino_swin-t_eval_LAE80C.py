# LAE-DINO：仅在 LAE-80C 上评测（80 类）。需 data/LAE-80C/{images,LAE-80C-benchmark.json}
# 用法: ./tools/dist_test.sh configs/lae_dino/lae_dino_swin-t_eval_LAE80C.py /path/to.pth 4
# 与 DIOR 微调配置相比：数据换为 LAE-80C，bbox_head.num_classes=80
_base_ = [
    '../_base_/datasets/lae_80c_detection.py',
