...
class BertEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        # GroundingDINO-style sub-sentence prompting may pass a 3D attention
        # mask. Newer HuggingFace BERT defaults to SDPA, whose mask utility
        # assumes a 2D mask here. Force the eager attention path for
        # compatibility with the legacy mask format used in this project.
