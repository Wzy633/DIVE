...
class LAEDINO(DINO):
    ...
    def forward_transformer(
        ...
        text_dict = new_text_dict
        return head_inputs_dict, loss_visgt_
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        for data_samples in batch_data_samples:
            ...
            if len(text_tuple) > 60:
                ...
                uni_label = list(set(gt_lable_list))
        ...
        head_inputs_dict, loss_visgt_ = self.forward_transformer(visual_features, text_dict,
                                                    batch_data_samples)
        ...
        losses_sup = rename_loss_dict('', reweight_loss_dict(losses_sup_, 1)) # 设置域值
